...
# VERSION_FILE_ABS_PATH = os.path.join(DIRNAME,constant.VERSION_FILE)
...
def train(args):
    ...
    for epoch in tqdm(range(args.epochs), desc='epochs'):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), os.path.join(save_best_path, 'best_model.bin'))
...
def main():
    ...
    parser.add_argument("--dev_data_path", default='./data/korean_single_dev_r.csv', type=str,
                        help="dev data path")
    # parser.add_argument("--train_data_path",
    #                     default='./drive/My Drive/pytorch-bert-korean/data/korean_single_test.csv', type=str,
    #                     help="train data path")
    # parser.add_argument("--dev_data_path", default='./drive/My Drive/pytorch-bert-korean/data/korean_single_test.csv',
    #                     type=str,
    #                     help="dev data path")
...
if __name__ == '__main__':
    fc.clear()
    azs = fc.init_azure_service()

    # version_string = fc.down_load_version(azs, constant.STORAGE_TEXTCNN_DIR, VERSION_FILE_ABS_PATH)
    # cv = fc.get_version(version_string)
    # uv = fc.update_version(cv)
    # fc.set_version(uv, VERSION_FILE_ABS_PATH)
    ...
    # fc.rm_version(VERSION_FILE_ABS_PATH)
    logger.info("Uploaded best model at azure")
